...
public class TelaUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnInformacaoVeiculo = new javax.swing.JButton();
        ...
        btnInformacaoVeiculo.setBackground(new java.awt.Color(153, 204, 255));
        btnInformacaoVeiculo.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnInformacaoVeiculo.setForeground(new java.awt.Color(0, 0, 204));
        btnInformacaoVeiculo.setText("Informações do veiculo");
        btnInformacaoVeiculo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnInformacaoVeiculoActionPerformed(evt);
            }
        });
        getContentPane().add(btnInformacaoVeiculo, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 270, 200, 30));
    ...
    private void btnInformacaoVeiculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInformacaoVeiculoActionPerformed
        JOptionPane.showMessageDialog(null, "Seu seguro é " + tipodeseguro );
    }//GEN-LAST:event_btnInformacaoVeiculoActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnFalarAtendente;
    private javax.swing.JButton btnInformacaoVeiculo;
