...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtEmail.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 102), 3));
        ...
        txtEmail.setBounds(200, 180, 270, 40);
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        try {
            ...
            if (resultado.next()) {
                ...
                PlacaVeiculo = resultado.getString("PlacaVeiculo");

                //Abrir o formulário Menu.java
                TelaPagamento tela;
                tela = new TelaPagamento(nome, cpf, email, endereco, PlacaVeiculo);
